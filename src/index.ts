            ...
            resultDiv.innerHTML = \`
                <div class="result">
                    ...
                    <details style="margin-top: 20px;">
                        ...
                        <div style="background: #f8f9ff; padding: 20px; border-radius: 8px; font-size: 0.9em; margin-top: 10px;">
                            <ul style="list-style-type: none; padding-left: 0; line-height: 1.6;">
                                ...
                                <li><strong>Emotion Shifts:</strong> \${result.updated_profile.emotion_shifts?.join(', ') || 'None'}</li>
                                ...
                                <li><strong>Last Updated:</strong> \${result.updated_profile.last_updated ? new Date(result.updated_profile.last_updated).toLocaleString() : 'N/A'}</li>
                            </ul>
                        </div>
                        <details style="margin-top: 10px;">
                            <summary style="cursor: pointer; font-weight: 500; color: #555;">Raw JSON</summary>
                            <pre style="background: #edf2f7; padding: 12px; border-radius: 6px; overflow-x: auto; font-size: 0.8em;">\${JSON.stringify(result.updated_profile, null, 2)}</pre>
                        </details>
                    </details>
                </div>
            \`;
